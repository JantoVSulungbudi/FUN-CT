...
function createScanner() {
    ...
    holeMat.diffuseColor = new BABYLON.Color3(0.1, 0.1, 0.2);
    holeMat.alpha = 0.1;
    gantryHole.material = holeMat;
...
// Getters for scene elements - THIS IS THE CRITICAL EXPORT THAT WAS MISSING
